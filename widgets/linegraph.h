 ...
 *
 *      Real Time Plotting:
 *      {P0|Line Name|255,0,0|value|Other Line Name|255,0,0|value}
 *              Example: Sample real-time packet with 3 curves XYZ
 *                      {P0|X|255,0,0|100|Y|0,255,0|150|Z|0,0,255|200}
 *
 *
 *      Sample XY plot (supports only one curve):
 *          {P0|Some XY plot|255,0,0|1 255 2 200 3 150 4 100}
 *          {Plot ID|Curve name|Color|X Y X Y X Y X Y.....}
 *          Note: If for each X value there won't be Y value, the plot will be ignored
 *
 */
...
class LineGraph : public AbstractWidget
{
    Q_OBJECT
