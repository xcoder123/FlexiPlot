...
void Config::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->savedStatusChanged((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Config::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Config::savedStatusChanged)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void Config::savedStatusChanged(bool _t1)
{
